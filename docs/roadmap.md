...
| M5 | Company discovery & profile | **Done** (2026-07-12; qualification-hardened 2026-07-18) | [M5-discovery-profiles.md](milestones/M5-discovery-profiles.md) | Merge-safe evidence chain; indexed conservative identity matching/authority; full scope facets; CSV/JSON/JSONL/ZIP discovery; source-lineage-aware corroboration and lifecycle refresh (migrations 0015–0016) |
