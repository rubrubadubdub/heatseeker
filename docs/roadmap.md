...
| — | Deterministic lead research loop (bounded hostname discovery, gap-directed live-web fallback, verified domain admission, deep first-party fetch, export quality gate) | **Done** (2026-07-18; ADR-0016) | see M5/M8 briefs | No offline enrichment; unchanged exhausted gap signatures terminate |
...
| M5 | Company discovery & profile | **Done** (2026-07-12; qualification-hardened 2026-07-18) | [M5-discovery-profiles.md](milestones/M5-discovery-profiles.md) | Merge-safe evidence chain; indexed conservative identity matching/authority; full scope facets; CSV/JSON/JSONL/ZIP discovery; public-profile cross-source identity evidence; source-lineage-aware corroboration and lifecycle refresh (migrations 0015–0016) |
| M6 | Projects, relationships, graph | **Done** (2026-07-13; qualification-hardened 2026-07-18) | [M6-projects-graph.md](milestones/M6-projects-graph.md) | Evidence-validated writes; qualified-participation traversal; immutable history and audit; set-based derived edges; BFS paths with per-hop confidence |
...
| ~~Parser-driven claims from crawled pages~~ **Landed 2026-07-18, deepened by ADR-0016**: gap-directed website profile fetch (`company_profiles.py` + `page_extraction.py`) — robots-honoured bounded page frontier; rule-based contacts/forms/addresses/descriptions/branch/system/service extraction; missing domains use verified live-web lookup; jobs stop on unchanged gap signatures | §41.19 — quality results with AI disabled for known domains; safe live discovery for missing domains | Done (extend rules as needed) |
